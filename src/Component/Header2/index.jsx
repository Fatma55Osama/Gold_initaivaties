    ...
    <div className="col-12  align-items-start d-flex justify-content-start">
      <div className="col-12 col-md-11 col-lg-8 " id={styles.halfheader}>
        <div
          className={
            styles.part1 +
            "  px-2 d-flex align-items-center justify-content-between py-2 px-md-3"
          }
        >
          <div className="d-none d-md-flex align-items-center gap-2 gap-md-4 ">
            ...
            <div className="d-flex align-items-center  gap-2 gap-md-3">
              ...
              <a
                href="https://www.facebook.com/share/16iwfH8UVT/?mibextid=qi2Omg"
                target="_blank"
              >
                <FaFacebook className={styles.icon} title="فيسبوك" />
              </a>
              <a
                href="https://instagram.com/mohpegypt?igshid=1t65jqxaoiwqb"
                target="_blank"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UCzEGfjELHCOQxgPr0dll1pA?pbjreload=10"
                target="_blank"
              >
          ...
          <a
            href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(contactfooter[0]?.location)}`}
            className={" nav-link"}
            target="_blank"
          >
            <span>
              {" "}
              <span id={styles.asema}> {contactfooter[0]?.address}</span>{" "}
          ...
          <div id={styles.dateday} className="text-end me-md-5 pe-md-5 ">
            {" "}
        ...
        <div className={styles.part2 + " d-none d-md-flex"}>
          <div className=" col-12 col-md-12  me-md-5 me-lg-5 container  pe-5 py-2 py-md-3 py-lg-3 d-flex justify-content-between align-items-center  h-100 ">
            {path.map((el, index) => {
              ...
              // 👇 هل ده لينك تسجيل الدخول؟
              const isLoginLink = el.name === "تسجيل الدخول";
        ...
        {/* mobile view */}
        <div
          className={`d-flex d-md-none justify-content-between align-items-center w-100 px-3 py-2`}
        >
      ...
      {showMobileMenu && (
        ...
        >
          ...
          <div
            className="d-flex flex-column-reverse flex align-items-end w-100"
            id={styles.gaptextheader}
          >
            {path.map((el, index) => {
              const isActive = el.links.some((link) =>
                link.path === "/"
              ...
              if (el.name === "الركن الإعلامي") {
                return (
                  <Accordion
                    key={index}
                    className={`w-100 mb-2 border-0 mediaAccordion ${styles.mediaAccordion}`}
                    alwaysOpen
                  >
                    <Accordion.Item eventKey="0" className="border-0">
                      <Accordion.Header
                        className={`w-100 p-0 m-0 bg-transparent border-0`}
                      >
                        <div className="w-100 d-flex flex-row-reverse justify-content-between align-items-center">
                          <span className={`${styles.linkfont}`}>
                            {el.name} <span className="accordion-icon" />
                          </span>
                        </div>
                      </Accordion.Header>

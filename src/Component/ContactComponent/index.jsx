...
const token = localStorage.getItem("token");
    return (
        <div>
                            ...
                            <div className='col-12  ' id={styles.regtangle}>
                                <div className='container '>
                                    <p className='justifyText '>
                                        تهتم المبادرة بتحقيق التواصل المستمر مع المستفيدين وذلك لتحقيق أعلى قدر من الخدمات، لذا يمكنكم التواصل مع المبادرة عبر وسائل التواصل التالية:</p>
            ...
            {
                props.hiddenheader == "d-none" ? ("") : (
                    <header className={` col-12  ${props.showheadsm == "d-flex" ? "d-flex flex-column-reverse gap-4 gap-md-0 flex-md-row align-items-end  flex-wrap  justify-content-end" : "d-none"} d-md-flex  mt-5   container  ${props.none === "d-none" ? " justify-content-end" : " justify-content-between"} ${props.hidden == "d-flex" ? " d-none" : "d-flex"} `}>
                        ...
                        <div className={`d-flex  mb-2 gap-3 gap-md-4 justify-content-between  align-items-md-center `}>

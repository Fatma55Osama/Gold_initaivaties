...
//             />
//             <div>
//             <img src={vector} width={10} className="position-absolute vector1"alt="" /> {/*الوادي الجديد*/}
//             <img src={vector} width={10} className="position-absolute vector2" alt="" /> {/*الجيزة*/}
//             <img src={vector} width={10} className="position-absolute vector3" alt="" /> {/*مرسى مطروح*/}

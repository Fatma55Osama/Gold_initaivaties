...
export default function HospitalService() {
  ...
  return (
    <div>
      ...
      <div
        className={
          " col-12 container d-flex flex-column gap-4 pb-3 align-items-end  mt-5 mb-5 " +
          styles.containerhospital
        }
      >
        <h2> {detailservice[0]?.mashoraDesc} </h2>
        <span
          className={styles.bookingmashora}
          onClick={() => {
            openModalmashora();
          }}
        >
          اضغط هنا لحجز مشورة اون لاين
        </span>
        ...
        <div className="col-12 d-flex  justify-content-end my-3 gap-3">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{ __html: detailservice[0]?.servDesc }}
          />
        </div>
        <div
          onClick={openModalpdf}
          className={
            styles.btnback + " px-1 rounded-3 d-flex align-items-center"
          }
        >
